...
public class ParserBaba extends DataParser {
	...
	private double currNetIncome;
	private double currNonGAAPNetIncome;

	// following are created, but we don't have to use them
	// if delete, then need to adjust code below
	private double prevRevenue;
	private double prevNetIncome;
	private double numNetIncomeChange;

	// created, by not all are needed
	private double prevNonGAAPNetIncome;
	private double numNonGAAPNetIncomeChange;
	...
	public double parseRevenue() {
		...
		// our regex:
		// start of a line, starts with "Revenue", followed by a space, followed by 1 or
		// more digits
		// thus: ^Revenue\s\d{1,}
...
//	} //END parseRevenue method
	...
	public double parseNetIncome() {
		...
		// File babaQuarter = new File("201409_converted.txt");
		// our regex:
		// start of a line, starts with "Net Income", followed by a space, followed by 1
		// or more digits
	...
	/**
	 * method is more tricky because non-GAAP NetIncome is split over two lines line
	 * 1: "NonGAAPNetIncome line 2: the actual data
	 * 
...
//				    }//END WHILE 
	...
	/**
	 * parseYearQuarterCompany runs through the file and assigns the appropriate
	 * values to the year, quarter, and companyName instance variables.
	 */
	public void parseYearQuarterCompany() {
		...
		year = Integer.parseInt(sentence[indexOfYear]);

	} // END parseFinancialYearQuarterCompany method
	
	/**
	 * getYear is an accessor method returning the int value of the year of
	...
	/** 
	 * getQuarter is an accessor method returning the int value of the quarter
	...
	/**
	 * getCompanyName is an accessor method returning the String value of the 
	 * company name.
	 * @return company name
	 */
